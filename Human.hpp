...
public:
    ...
    Human( const std::string& _chname, long& _race, int& _level, Armor* armor, Weapon* weapon, Apparel* apparel )
    {
...
private:
    ...
    virtual void SetCharStats( const std::string& _chname, long& _race, int& _level, Armor* armor, Weapon* weapon, Apparel* apparel )
    {
        ...
        this->_character._id = IDs::race::CHAR_HUMAN;
        this->_character._lvl = 1;
        this->_character._hp = 100;
        this->_character._mp = 1;
        this->_character._exp = 1;
        this->_character._dex = 4;
        this->_character._stamina = 5;
        this->_character._strenght = 7;
        this->_character._inteligence = 3;

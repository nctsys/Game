...
public:
    ...
    Dwarf( const std::string& _chname, long& _race, int& _level, Armor* armor, Weapon* weapon, Apparel* apparel )
    {
...
private:
    ...
    {
        double def, atk, chmax_speed, chmin_speed;
        
        this->_character._name = _chname;
        this->_character._id = IDs::race::CHAR_DWARF;
        this->_character._lvl = 1;
        this->_character._hp = 100;
        this->_character._mp = 1;
        this->_character._exp = 1;
        this->_character._dex = 2;
        this->_character._stamina = 6;
        this->_character._strenght = 3;
        this->_character._inteligence = 7;
